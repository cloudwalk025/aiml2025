# Generated by Django 5.2.3 on 2025-09-04 21:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_type', models.CharField(blank=True, choices=[('student_early', 'Student (Early)'), ('student_late', 'Student (Late)'), ('academic_early', 'Academic (Early)'), ('academic_late', 'Academic (Late)'), ('industry_early', 'Industry (Early)'), ('industry_late', 'Industry (Late)')], max_length=20)),
                ('registration_fee', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('payment_option', models.CharField(blank=True, choices=[('credit_card', 'Credit Card')], max_length=20)),
